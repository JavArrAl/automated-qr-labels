...
PUMPS_MODELS = {
    'AMBIX ACTIVE KIT': ['AMBIX ACTIVE KIT', 'AMBIX ACTIVE', 'AMBIX', 'Ambix active', 'ambix active'],
    ...
    'RYTHMIC PN PLUS PUMP': ['RYTHMIC PN PLUS PUMP', 'RYTHMIC PN +', 'PN +', 'PN+', 'RYTHMIC PN+', 'RYTHMIC PN PLUS'],
